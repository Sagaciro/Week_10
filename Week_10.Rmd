...
```{r}
matrix_profile_ecoli <- read_delim("/Volumes/LaCie/PRISA/PanPlAn3_protocol/matrix_profile_ecoli_3.tsv", 
                                   delim = "\t", escape_double = FALSE, 
                                   trim_ws = TRUE)
View(matrix_profile_ecoli)

colnames(matrix_profile_ecoli)[1] <- "Annotation"
```
